---
permalink: copy-based/reference_copyright.html 
sidebar: sidebar 
keywords: ontap, copy, based, transition, copyright 
summary: 'Informations sur le copyright pour le guide de transition basé sur des copies de l"outil 7-mode transition Tool.' 
---
= Droits d'auteur
:allow-uri-read: 
:icons: font
