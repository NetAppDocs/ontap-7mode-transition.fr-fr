---
permalink: command-map/reference_copyright.html 
sidebar: sidebar 
keywords: ontap, command, map, transition, copyright 
summary: Guide des administrateurs sur le copyright du schéma de commandes pour 7-mode. 
---
= Droits d'auteur
:allow-uri-read: 
:icons: font
